...
@section('admin_content')
          ...
          <div class="  card text-dark">
              <div class="card-header">
                ...
                <h3 class="card-title font-weight-bold">Featured Recipe Update Form</h3>
              </div>
              <!-- /.card-header -->
              <div class="row justify-content-center card-body">
                <div class="col-md-6">

                      <form role="form" method="POST" action="{{url('admin/FeaturedRecipe/featuredrecipe-update/'.$recipe_edit->id)}}" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="form-group float-right">
                          ...
                          class="btn btn-info"
                          type="submit"
                          name="button"><i class="fas fa-plus-square"></i>&nbsp;&nbsp;Update Featured Recipe</button>
                        </div>
